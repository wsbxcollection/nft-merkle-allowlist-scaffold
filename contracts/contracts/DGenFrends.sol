...
contract DGenFrends is ERC721URIStorage, Ownable, ReentrancyGuard{
    ...
    /**
      ...
      * public mint from 1001 - 10000 (9000 max supply)
    **/
    ...
    constructor(string memory _baseURI, string memory collectionURI) ERC721("DGenFrends", "DGNF") {
        setBaseURI(_baseURI);
    ...
    * max supply 9000, no limit on # of tokens
    */
    function publicMint(
      uint256 numberOfTokens
        ...
        nonReentrant
    {
	    require(isPublic, "The public sale is not active");
